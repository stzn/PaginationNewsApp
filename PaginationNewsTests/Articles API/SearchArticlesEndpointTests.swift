...
class SearchArticlesEndpointTests: XCTestCase {
    func test_searchArticles_endpointURL() {
        ...
        let received = SearchArticlesEndpoint.get(keyword: "keyword", page: 1, pageSize: 20, language: "en").url(baseURL: baseURL)
        ...
        XCTAssertEqual(received.query?.contains("language=en"), true,  "country query param")
